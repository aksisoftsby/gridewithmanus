...
Route::get('/driver/kendaraan', [ApiController::class, 'kendaraanList']);
Route::post('/driver/kendaraan', [ApiController::class, 'kendaraanStore']);
Route::put('/driver/kendaraan/{id}', [ApiController::class, 'kendaraanUpdate']);
Route::delete('/driver/kendaraan/{id}', [ApiController::class, 'kendaraanDestroy']);
Route::patch('/driver/kendaraan/{id}/toggle-aktif', [ApiController::class, 'kendaraanToggleAktif']);
