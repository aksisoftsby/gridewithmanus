...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Transaksi Wallet: {{ $user->full_name }}</h1>
            <p class="text-sm text-gray-500">Riwayat transaksi GrSaldo user (view-only)</p>
        </div>
        <div class="flex gap-3">
            ...
            <a href="{{ route('kota.wallets.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded-lg text-sm font-semibold transition">
