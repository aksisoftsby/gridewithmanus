...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Wallet Driver: {{ $driver ? $driver->full_name ?? auth()->user()->full_name : '-' }}</h1>
            <p class="text-sm text-gray-500">Transaksi wallet driver (view-only)</p>
        </div>
