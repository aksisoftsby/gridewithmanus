            ...
            <tbody class="divide-y divide-gray-100 text-sm">
                @forelse($products as $product)
                    <tr>
                        ...
                        <td class="px-6 py-4 font-semibold text-pink-700">Rp {{ number_format($product->price, 0, ',', '.') }}</td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <a href="{{ route('admin.products.edit', $product->id) }}" class="text-pink-700 hover:text-pink-900 font-medium text-xs"><i class="fa-solid fa-pen-to-square mr-1"></i>Edit</a>
