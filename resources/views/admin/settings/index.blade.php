...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <form action="{{ route('admin.settings.update') }}" method="POST">
        ...
        <div class="bg-white rounded-xl shadow border border-gray-100 p-6 mb-6">
            <h3 class="font-bold text-gray-800 text-lg mb-4"><i class="fa-solid fa-car text-emerald-600 mr-2"></i>Tarif Ride / Antar-Jemput</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" min="0" step="1" name="ride_cost_per_km" value="{{ $settings['ride_cost_per_km'] }}" class="w-full border border-gray-300 rounded-lg pl-8 pr-3 py-2 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-2 text-gray-400 text-xs">Rp</span>
                        <input type="number" min="0" step="1" name="ride_base_fare" value="{{ $settings['ride_base_fare'] }}" class="w-full border border-gray-300 rounded-lg pl-8 pr-3 py-2 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                    </div>
                ...
                <div>
                    ...
                    <select name="admin_ride_commission_enabled" id="adminRideEnabled" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-2 text-gray-400 text-xs">Rp</span>
                        <input type="number" min="0" step="1" id="adminRideAmount" name="admin_ride_commission_amount" value="{{ $settings['admin_ride_commission_amount'] }}" class="w-full border border-gray-300 rounded-lg pl-8 pr-3 py-2 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                    </div>
                </div>
            </div>
        </div>
        ...
        {{-- FOOD --}}
        <div class="bg-white rounded-xl shadow border border-gray-100 p-6 mb-6">
            <h3 class="font-bold text-gray-800 text-lg mb-4"><i class="fa-solid fa-utensils text-emerald-600 mr-2"></i>Komisi Food / Restro</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                    <label class="block font-medium text-gray-700 mb-1">Komisi Food (Restro) %</label>
                    <div class="relative">
                        <input type="number" min="0" max="100" step="0.01" name="food_commission_pct" value="{{ $settings['food_commission_pct'] }}" class="w-full border border-gray-300 rounded-lg px-3 pr-8 py-2 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                ...
                <div>
                    ...
                    <select name="admin_food_commission_enabled" id="adminFoodEnabled" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="relative max-w-sm">
                        <span class="absolute left-3 top-2 text-gray-400 text-xs">Rp</span>
                        <input type="number" min="0" step="1" id="adminFoodAmount" name="admin_food_commission_amount" value="{{ $settings['admin_food_commission_amount'] }}" class="w-full border border-gray-300 rounded-lg pl-8 pr-3 py-2 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                    </div>
                </div>
            </div>
        </div>
        ...
        {{-- SHOP --}}
        <div class="bg-white rounded-xl shadow border border-gray-100 p-6 mb-6">
            <h3 class="font-bold text-gray-800 text-lg mb-4"><i class="fa-solid fa-store text-emerald-600 mr-2"></i>Komisi Toko / Shop</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                    <label class="block font-medium text-gray-700 mb-1">Potongan Komisi Admin Toko / Shop</label>
                    <select name="admin_shop_commission_enabled" id="adminShopEnabled" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                ...
                <div>
                    ...
                    <div class="relative max-w-sm">
                        <span class="absolute left-3 top-2 text-gray-400 text-xs">Rp</span>
                        <input type="number" min="0" step="1" id="adminShopAmount" name="admin_shop_commission_amount" value="{{ $settings['admin_shop_commission_amount'] }}" class="w-full border border-gray-300 rounded-lg pl-8 pr-3 py-2 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                    </div>
                </div>
            </div>
        ...
        {{-- APK DOWNLOAD --}}
        <div class="bg-white rounded-xl shadow border border-gray-100 p-6 mb-6">
            <h3 class="font-bold text-gray-800 text-lg mb-4"><i class="fa-solid fa-download text-emerald-600 mr-2"></i>Tautan Unduh APK</h3>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                <div>
                    <label class="block font-medium text-gray-700 mb-1">Customer</label>
                    <input type="url" name="apk_download_url_customer" value="{{ $settings['apk_download_url_customer'] }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                </div>
                <div>
                    <label class="block font-medium text-gray-700 mb-1">Driver</label>
                    <input type="url" name="apk_download_url_driver" value="{{ $settings['apk_download_url_driver'] }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                </div>
                <div>
                    <label class="block font-medium text-gray-700 mb-1">Merchant</label>
                    <input type="url" name="apk_download_url_merchant" value="{{ $settings['apk_download_url_merchant'] }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                </div>
            </div>
                        ...
                        <tbody class="divide-y divide-gray-100 text-sm">
                            @foreach($links as $link)
                                <tr>
                                    ...
                                    <td class="px-4 py-3">
                                        <a href="{{ $link['url'] }}" target="_blank" class="text-emerald-600 hover:underline text-xs font-medium"><i class="fa-solid fa-download mr-1"></i> Unduh ZIP (GitHub)</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
