    ...
    <div class="bg-white rounded-xl shadow border border-gray-100 p-4 mb-6">
        <form method="GET" class="flex flex-wrap gap-3 items-end">
            <div class="flex-1 min-w-[180px]">
                ...
                <input type="text" name="search" value="{{ $search }}" class="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-pink-600" placeholder="Judul / deskripsi...">
            </div>
            <div class="w-44">
                <label class="block text-xs font-semibold text-gray-600 mb-1">Kategori</label>
                <select name="category_id" class="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-pink-600">
            ...
            <div class="w-40">
                ...
                <select name="status" class="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-pink-600">
            ...
            <button type="submit" class="bg-pink-700 hover:bg-pink-800 text-white px-4 py-2 rounded-lg text-sm font-semibold shadow transition">Filter</button>
            ...
            <tbody class="divide-y divide-gray-100 text-sm">
                @forelse($iklan as $item)
                    <tr>
                        ...
                        <td class="px-6 py-4 font-semibold text-pink-700">Rp {{ number_format((float)$item->price, 0, ',', '.') }}</td>
