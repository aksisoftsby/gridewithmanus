...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-3">
            <a href="{{ route('admin.news.create') }}" class="bg-pink-700 hover:bg-pink-800 text-white px-4 py-2 rounded-lg text-sm font-semibold shadow transition">
            ...
            <tbody class="divide-y divide-gray-100 text-sm">
                @forelse($news as $item)
                    <tr>
                        ...
                        <td class="px-6 py-4">
                            <span class="px-2.5 py-1 text-xs font-semibold rounded-full {{ $item->status == 'PUBLISHED' ? 'bg-pink-100 text-pink-900' : 'bg-blue-100 text-blue-800' }}">
                                {{ $item->status }}
                            </span>
                        </td>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <a href="{{ route('admin.news.edit', $item->id) }}" class="text-pink-700 hover:text-pink-900 font-medium text-xs"><i class="fa-solid fa-pen-to-square mr-1"></i>Edit</a>
