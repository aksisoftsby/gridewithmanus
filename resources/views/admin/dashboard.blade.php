...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex space-x-3">
            <a href="{{ route('admin.merchants.index') }}" class="bg-pink-700 hover:bg-pink-800 text-white px-4 py-2 rounded-lg text-sm font-semibold shadow transition">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6 mb-8">
        <div class="bg-white p-6 rounded-xl shadow border border-gray-100">
            ...
            <a href="{{ route('admin.users.index') }}" class="text-xs text-pink-700 hover:underline mt-2 inline-block">View details &rarr;</a>
        </div>
        <div class="bg-white p-6 rounded-xl shadow border border-gray-100">
            ...
            <a href="{{ route('admin.merchants.index') }}" class="text-xs text-pink-700 hover:underline mt-2 inline-block">View details &rarr;</a>
        </div>
        <div class="bg-white p-6 rounded-xl shadow border border-gray-100">
            ...
            <a href="{{ route('admin.orders.index') }}" class="text-xs text-pink-700 hover:underline mt-2 inline-block">View details &rarr;</a>
        </div>
        <div class="bg-white p-6 rounded-xl shadow border border-gray-100">
            <div class="text-gray-500 text-xs font-semibold uppercase">Completed Revenue</div>
            <div class="text-xl font-bold text-pink-700 mt-2">Rp {{ number_format($stats['revenue'], 0, ',', '.') }}</div>
        </div>
        <div class="bg-white p-6 rounded-xl shadow border border-gray-100">
        ...
        <div class="bg-white p-6 rounded-xl shadow border border-gray-100">
            ...
            <a href="{{ route('admin.promos.index') }}" class="text-xs text-pink-700 hover:underline mt-2 inline-block">View details &rarr;</a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow border border-gray-100 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center">
            ...
            <a href="{{ route('admin.orders.index') }}" class="text-sm text-pink-700 hover:underline">View All &rarr;</a>
        </div>
                ...
                <tbody class="divide-y divide-gray-100 text-sm">
                    @forelse($recentOrders as $order)
                        <tr>
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('admin.orders.show', $order->id) }}" class="text-pink-700 hover:text-pink-900 font-medium">Detail</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
