...
<body class="bg-slate-50 text-slate-900 overflow-x-hidden">
    ...
    <header class="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-900">
        ...
        <div class="container mx-auto px-6 relative z-10 text-center">
            <div class="inline-flex items-center space-x-2 bg-purple-600/10 border border-purple-600/20 px-4 py-2 rounded-full mb-8">
                <span class="w-2 h-2 bg-purple-600 rounded-full animate-pulse"></span>
                <span class="text-amber-400 text-sm font-semibold tracking-wide uppercase">Investment Proposal 2026</span>
            </div>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="#fitur" class="bg-purple-700 hover:bg-purple-600 text-white px-10 py-4 rounded-2xl font-bold text-lg transition-all shadow-lg shadow-purple-950/20">
    ...
    <section id="fitur" class="py-24 container mx-auto px-6">
        <div class="text-center mb-20">
            <h2 class="text-sm font-bold text-purple-700 uppercase tracking-[0.2em] mb-3">Ekosistem Terintegrasi</h2>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-8 rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-100 proposal-card">
                <div class="w-16 h-16 bg-purple-100 rounded-2xl flex items-center justify-center text-purple-700 text-2xl mb-8">
                ...
                <ul class="space-y-4">
                    <li class="flex items-start">
                        <i class="fa-solid fa-check-circle text-purple-600 mt-1 mr-3"></i>
    ...
    <section class="py-24 bg-white border-y border-slate-100">
        <div class="container mx-auto px-6">
            <div class="text-center mb-14">
                <h2 class="text-sm font-bold text-purple-700 uppercase tracking-[0.2em] mb-3">Ready for Distribution</h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                <div class="rounded-3xl bg-slate-900 p-7 text-white shadow-xl shadow-slate-200/50">
                    <div class="flex items-center justify-between mb-7">
                        <div class="w-14 h-14 rounded-2xl bg-purple-600/20 flex items-center justify-center text-amber-400 text-2xl"><i class="fa-solid fa-mobile-screen-button"></i></div>
                        <span class="text-[10px] uppercase tracking-widest font-bold text-purple-300 bg-purple-600/10 px-3 py-1.5 rounded-full">End User</span>
                    </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center gap-3 rounded-2xl bg-white/10 border border-white/10 px-4 py-3"><i class="fa-brands fa-google-play text-xl text-amber-400"></i><div><div class="text-[10px] text-slate-400 uppercase tracking-wider">Build</div><div class="font-semibold text-sm">Android APK / Google Play</div></div></div>
            ...
            <div class="mt-10 flex flex-wrap justify-center gap-3 text-xs font-semibold text-slate-500">
                <span class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-50 border border-slate-200"><i class="fa-solid fa-code-branch text-purple-700"></i> One shared backend API</span>
                <span class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-50 border border-slate-200"><i class="fa-solid fa-arrows-rotate text-purple-700"></i> Cross-platform release workflow</span>
                <span class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-50 border border-slate-200"><i class="fa-solid fa-cloud-arrow-up text-purple-700"></i> Production deployment support</span>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-slate-900 text-white overflow-hidden relative">
        <div class="container mx-auto px-6 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-16">
                <div class="lg:w-1/2">
                    <h2 class="text-sm font-bold text-amber-400 uppercase tracking-[0.2em] mb-3 text-left">Teknologi Mutakhir</h2>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div class="flex items-center space-x-4">
                            <div class="w-12 h-12 bg-white/5 rounded-xl flex items-center justify-center text-amber-400">
                ...
                <div class="lg:w-1/2 relative">
                    <div class="bg-purple-600/20 absolute inset-0 blur-[100px] rounded-full"></div>
                    <div class="bg-glass border border-white/10 p-8 rounded-[2.5rem] relative z-20">
                        <div class="flex items-center justify-between mb-8">
                            ...
                            <span class="bg-purple-100 text-purple-800 text-xs font-bold px-3 py-1 rounded-full uppercase">Super Admin</span>
                        </div>
                        <div class="space-y-4">
                            <div class="h-4 bg-slate-200 rounded-full w-3/4"></div>
                            <div class="h-4 bg-slate-100 rounded-full w-1/2"></div>
                            <div class="grid grid-cols-3 gap-4 mt-6">
                                <div class="h-20 bg-purple-50 rounded-2xl flex flex-col items-center justify-center">
                                    <span class="text-purple-700 font-bold">1.2k</span>
                                    <span class="text-[10px] text-amber-400 uppercase">Orders</span>
                                </div>
                            ...
                            <div class="mt-6 p-4 bg-slate-900 rounded-xl border border-white/10">
                                <code class="text-xs text-amber-400 font-mono">
    ...
    <section id="pricing" class="py-24 container mx-auto px-6">
        <div class="text-center mb-16">
            <h2 class="text-sm font-bold text-purple-700 uppercase tracking-[0.2em] mb-3">Investment Opportunity</h2>
            <h3 class="text-4xl md:text-5xl font-bold text-slate-900">Penawaran Eksklusif Terbatas.</h3>
        </div>

        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-[3rem] shadow-2xl shadow-purple-200/50 border-4 border-purple-600 relative overflow-hidden">
                <!-- Promo Badge -->
                ...
                <div class="p-12 text-center border-b border-slate-100">
                    ...
                    <div class="flex items-center justify-center space-x-4 mb-4">
                        ...
                        <span class="bg-purple-100 text-purple-800 text-sm font-bold px-4 py-1 rounded-full">Save 50%</span>
                    </div>
                ...
                <div class="p-12 bg-purple-50/30">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            <h5 class="font-bold text-slate-900 mb-6 flex items-center">
                                <i class="fa-solid fa-gift text-purple-700 mr-2"></i> Paket Pembelian Termasuk:
                            </h5>
                            <ul class="space-y-4 text-left">
                                <li class="flex items-center text-slate-700">
                                    <i class="fa-solid fa-circle-check text-purple-600 mr-3"></i>
                                ...
                                <li class="flex items-center text-slate-700 font-bold text-purple-800">
                                    <i class="fa-solid fa-circle-check text-purple-600 mr-3"></i>
                        ...
                        <div>
                            <h5 class="font-bold text-slate-900 mb-6 flex items-center">
                                <i class="fa-solid fa-hand-holding-heart text-purple-700 mr-2"></i> Komitmen Kami:
                            </h5>
                            ...
                            <div class="p-4 bg-white rounded-2xl border border-purple-100 shadow-sm">
            ...
            <div class="max-w-4xl mx-auto bg-white p-12 rounded-[2.5rem] shadow-xl border border-slate-100">
                <div class="flex flex-col md:flex-row items-center justify-between mb-12 gap-6">
                    ...
                    <div class="text-right">
                        <div class="text-3xl font-black text-purple-700">Rp 10.000.000 <span class="text-sm font-normal text-slate-400">/ tahun</span></div>
                        <p class="text-xs text-slate-400 mt-1">*Berlaku setelah masa free 6 bulan habis</p>
                    </div>
                </div>

                <!-- Server Cost Explanation -->
                <div class="mb-12 bg-gradient-to-br from-purple-50 to-blue-50 border border-purple-100 rounded-2xl p-8">
                    <h6 class="font-bold text-slate-900 mb-4 flex items-center">
                        <i class="fa-solid fa-server text-purple-700 mr-3 text-lg"></i>
                        Transparansi Biaya Server & Skalabilitas
                    </h6>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="bg-white rounded-xl p-6 shadow-sm">
                            <div class="text-3xl font-black text-purple-700 mb-2">± Rp 500rb <span class="text-sm font-normal text-slate-400">/ bulan</span></div>
                        ...
                        <div class="bg-white rounded-xl p-6 shadow-sm">
                            <div class="text-3xl font-black text-purple-700 mb-2">10rb - 50rb</div>
                        ...
                        <div class="bg-white rounded-xl p-6 shadow-sm">
                            <div class="text-3xl font-black text-purple-700 mb-2">Auto Scale</div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                    <div class="flex space-x-4">
                        <div class="flex-shrink-0 w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center text-purple-700">
    ...
    <section class="py-24 container mx-auto px-6">
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white rounded-[2rem] shadow-xl border border-slate-100 overflow-hidden">
                <div class="bg-gradient-to-r from-purple-700 to-purple-800 text-white p-6 md:p-8 flex flex-col md:flex-row md:items-center gap-4">
                    ...
                    <span class="bg-white text-purple-800 font-black px-5 py-2 rounded-full text-sm uppercase tracking-wider">Landing & Presentation</span>
                </div>
                <div class="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4">
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Branding Presentasi Gride</strong> &mdash; Identitas visual premium yang membangun kepercayaan investor &amp; calon pengguna.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Informasi Publik Merchant</strong> &mdash; Katalog restoran, toko sembako, dan retail lengkap dengan lokasi peta.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Menarik Customer via Website</strong> &mdash; Promo &amp; voucher, news, testimonial, dan halaman proposal investasi.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Link Download APK</strong> &mdash; Gerbang distribusi aplikasi Customer, Merchant, dan Driver.</p></div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2rem] shadow-xl border border-slate-100 overflow-hidden">
                <div class="bg-gradient-to-r from-slate-800 to-slate-900 text-white p-6 md:p-8 flex flex-col md:flex-row md:items-center gap-4">
                    ...
                    <span class="bg-purple-600 text-white font-black px-5 py-2 rounded-full text-sm uppercase tracking-wider">Super Admin</span>
                </div>
                <div class="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4">
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Data Management</strong> &mdash; Lihat, edit, dan hapus data user, merchant, driver, dan customer.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Tambah User / Driver / Merchant</strong> &mdash; Onboarding mitra baru langsung dari panel admin.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Monitoring Order &amp; Transaksi</strong> &mdash; Pantau status order seluruh ekosistem &amp; seluruh sesi chat antar pengguna.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">News, Promo &amp; Testimonial</strong> &mdash; Kelola konten publik, promo dengan jadwal, dan rating merchant.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Search &amp; Filter</strong> &mdash; Pencarian cepat untuk setiap data: user, driver, merchant, order.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Dokumentasi API &amp; Download APK</strong> &mdash; Akses internal API docs dan tombol download build aplikasi.</p></div>
                </div>
            </div>

            <!-- 3. Customer App -->
            <div class="bg-white rounded-[2rem] shadow-xl border border-slate-100 overflow-hidden">
                <div class="bg-gradient-to-r from-purple-600 to-purple-600 text-white p-6 md:p-8 flex flex-col md:flex-row md:items-center gap-4">
                    <div class="flex-shrink-0 w-14 h-14 bg-white/15 rounded-2xl flex items-center justify-center text-2xl">
                        <i class="fa-solid fa-mobile-screen-button"></i>
                    </div>
                    <div class="flex-grow">
                    ...
                    <span class="bg-white text-purple-800 font-black px-5 py-2 rounded-full text-sm uppercase tracking-wider">Android &amp; iOS</span>
                </div>
                <div class="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4">
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">GrideFood &amp; Mart</strong> &mdash; Pesan makanan &amp; belanja sembako dengan filter lokasi real-time.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Menu Kirim &amp; Antar</strong> &mdash; Pesan antar-jemput orang &amp; barang ke titik GPS dengan hitung ongkir otomatis per KM.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Maps Point Picker</strong> &mdash; Pilih lokasi penjemputan &amp; tujuan langsung dari peta dengan presisi tinggi.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Live Tracking</strong> &mdash; Pantau posisi driver secara real-time saat pengiriman berlangsung.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Auto-Slide News</strong> &mdash; Berita dan promo terbaru langsung di beranda aplikasi.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Wallet &amp; History</strong> &mdash; Saldo, riwayat transaksi, dan penggunaan promo/voucher transparan.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Chat &amp; Rating</strong> &mdash; Komunikasi langsung dengan driver/merchant dan penilaian layanan.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Universal Login</strong> &mdash; Satu akun untuk semua layanan Gride dengan auto-retry koneksi server.</p></div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2rem] shadow-xl border border-slate-100 overflow-hidden">
                ...
                <div class="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4">
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Product Management</strong> &mdash; Tambah, edit, dan hapus produk/menu serta kelola stok mandiri.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Order Management</strong> &mdash; Terima dan proses pesanan masuk dengan notifikasi real-time.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Merchant Wallet</strong> &mdash; Pantau saldo merchant, pemasukan, dan riwayat transaksi harian.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Store Settings</strong> &mdash; Update profil toko, jam operasional, lokasi, dan info merchant.</p></div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2rem] shadow-xl border border-slate-100 overflow-hidden">
                ...
                <div class="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4">
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Real-time Tracking</strong> &mdash; Update lokasi GPS otomatis untuk penugasan order yang akurat.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Wallet Driver</strong> &mdash; Pantau pendapatan real-time, saldo cair/pending, dan fitur pencairan (withdraw).</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Earnings History</strong> &mdash; Laporan detail pendapatan per order (driver_net) secara otomatis.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Order Flow Lengkap</strong> &mdash; Terima order, konfirmasi pickup, antarmakan, dan bukti penyerahan (POD).</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Universal Login</strong> &mdash; Satu akun untuk customer, driver, dan merchant bagi mitra multifungsi.</p></div>
                    <div class="flex space-x-3"><i class="fa-solid fa-check text-purple-700 mt-1"></i><p class="text-sm text-slate-600"><strong class="text-slate-900">Account Management</strong> &mdash; Kelola profil, kendaraan, dan status online/offline dari aplikasi.</p></div>
                </div>
            </div>
    ...
    <!-- Call to Action -->
    <footer class="py-24 bg-purple-700 text-white text-center">
        <div class="container mx-auto px-6">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-6">
                <a href="https://wa.me/6281234567890" target="_blank" class="bg-white text-purple-700 px-12 py-5 rounded-2xl font-black text-xl hover:scale-105 transition shadow-2xl">
                    <i class="fa-brands fa-whatsapp mr-2"></i> Hubungi Kami Sekarang
                </a>
                <a href="/" class="text-white hover:text-purple-200 font-bold underline underline-offset-8">
                    Kembali ke Beranda
                </a>
            </div>
            <div class="mt-20 pt-10 border-t border-purple-600/30 text-purple-200 text-sm">
